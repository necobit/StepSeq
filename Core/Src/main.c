...
//  HAL_TIM_Base_Start_IT(&htim2);
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //      HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_6); // GPIOBのPIN0に接続されたLEDをトグル
//      HAL_Delay(100);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_13, GPIO_PIN_RESET);
